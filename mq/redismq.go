...
func (this *RedisMQ) connect(server MQServer) (MQ, error) {
	this.locker.Lock()
...
func (this *RedisMQ) Send(msg *message.MQMessage) error {
	// this.locker.Lock()
	// defer this.locker.Unlock()
...
func (this *RedisMQ) Receive() (*message.MQMessage, error) {
	// this.locker.Lock()
	// defer this.locker.Unlock()
	if this.srcConn == nil {
...
func (this *RedisMQ) SrcLen() int64 {
	// this.locker.RLock()
...
func (this *RedisMQ) DestLen() int64 {
	// this.locker.RLock()
	// defer this.locker.RUnlock()
...
func (this *RedisMQ) IsStart() bool {
	// this.locker.RLock()
	// defer this.locker.RUnlock()
